	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.DrawE10s == true",
				conditionType = 1,
				conditions = 
				{
				},
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore ~= nil then \n   return QwertCore.Settings.WhmSavHotbar.UsePrepull.bool == true and Player.Job == 24 and Player.level >= 80\nend\nreturn Player.Job == 24 and Player.level >= 80",
				conditionType = 1,
				conditions = 
				{
				},
