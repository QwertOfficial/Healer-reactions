local tbl = 
{
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "99c94953-96de-6928-93ba-b59e36ebeaa1",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "f99d3957-e77b-86f8-9d1c-e0f4e1541eb4",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "0af3efb7-15be-892b-a4ba-3bd6f4a8c0f1",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "32af90a8-baca-b6b0-bdec-5cd9b17b0524",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "9ddab1e8-7a72-5bcb-a33e-cf4d5816f1a2",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "83d6318d-2cd8-6453-815a-4ede301da36f",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.DrawE5sChainLightning == true",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "28f9ddf3-abf9-2fee-93d9-5c663512b25c",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "30b2cbeb-ec7e-64e1-976b-3689bceafd64",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "d0dc4cd5-7550-f2d6-bc32-a5d19def775d",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.DrawE12sDebuffs == true",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "f87fe9f8-158c-d1d6-8b52-6150fe7974fc",
	},
	
	{
		...
		conditions = 
		{
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.CalloutE12sNumber == true",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "ddd2a96b-c642-3d84-a5aa-12ba8f152b27",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "af3ca58c-1d30-681a-89e6-8336e914368b",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return false end\nreturn QwertCore.Settings.SchSavHotbar.Heal.bool == false",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return false end\nreturn QwertCore.Settings.SchSavHotbar.TankHeal.bool == false",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.TankPhysick.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.TankAdlo.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.TankLustrate.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.TankAp.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.TankEt.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.TankGcd.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "49f07a4f-87a5-1457-adf2-d29451015ffa",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.TankHeal.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "3e71d54e-4e3d-6692-93b6-7e2c1478b610",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return false end\nreturn QwertCore.Settings.SchSavHotbar.TankExco.bool == false",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "1f2fd98b-5741-7589-880d-29b8edd3ccfb",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return false end\nreturn QwertCore.Settings.SchSavHotbar.PartyHeal.bool == false",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartyPhysick.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartyAdlo.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartyLustrate.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartyAp.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartySuccor.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartyFeyB.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartyWhisp.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartyIndom.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartyConsolation.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavHotbar.PartyGcd.bool == true",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "055bd8af-8f8c-dcad-93fc-c99d8ecb2323",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "f4917ab7-6085-58bb-a558-b5b465e6d2e4",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore == nil then return true end\nreturn QwertCore.Settings.SchSavPlacePet == true",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "cb509567-5ce2-2830-8a46-757dddd9f2c3",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "f31155ed-6237-8d06-a9b8-e8deb6393c1a",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore ~= nil then \n   return QwertCore.Settings.SchSavHotbar.UsePrepull.bool == true and Player.Job == 28\nend\nreturn Player.Job == 28",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "e07e58e8-7949-4ba9-b2de-0b35e0c75f79",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "b00f3ea2-66c8-3a1d-a2a7-5fb502455b47",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "3c5b09f9-7564-92dc-be42-69d86e63a133",
	},
}
