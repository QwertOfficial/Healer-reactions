local tbl = 
{
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "b3c3f589-b1c2-bbf6-839e-02774775655a",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "ff0f4fee-1010-11b4-b7a7-8eb6e9ceb6cd",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "cce3dbc5-fefc-a699-bcfc-f9877363e49e",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "49f84bb9-8f66-32b2-954d-efe0570546cd",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "ac43f618-54fd-8920-8cc4-8daa22dfb05f",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "7414de57-e46b-c4db-b61a-81a3667aec4d",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "f1afa9c1-533e-bae0-9c42-bf93acd89c71",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "2a5b8aad-0e08-d99e-bf33-668d0fcc0043",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "ad206037-9c96-7137-aa8e-6dfef3260414",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "a61c4516-ad06-b36c-a5da-22736f878265",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "fa018c8d-593c-ae6e-8ac6-77180b04504c",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "6842e23f-7bf5-aa94-8660-166a98e9a3a3",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "d036fcbd-e01f-1a2a-b800-d7e651cb24a4",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "651ada83-c351-b72e-8f9b-c5d138bf3803",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "7b427f86-ee01-2196-8654-32faa87d6976",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 2,
				conditionLua = "local target = EntityList:Get(eventArgs.detectionTargetID)\nlocal potency = 550\n\nif not target then return false end\n\nif target.HP.percent >= 100 then return false end\n\nif Player.levels[24] ~= Player.level and Player.level <= 10 then\n    return (target.HP.percent/100) <= 0.8\nend\n\nif Player.levels[24] ~= Player.level and Player.level > 10 and Player.level <= 60 then\n    local x = Player.level\n    local formula = ((-7.291666666666*(10^-9)*(x^3))+(8.749999999999*(10^-7)*(x^2))-(0.0000442708*x)+(0.0015625))\n    local HealInPercent\t= (formula * potency) - (0.0005696 * (\t\t80 - Player.levels[24]))\n    if QwertCore ~= nil then\n\t\t\t\t    return (target.HP.current + (Player.HP.max * HealInPercent * (math.random(975, 1025) / 1000))) / target.HP.max <= (QwertCore.Settings.WhmEvPartyOverhealAoe/100) + 1\n    end\n    return (target.HP.current + (Player.HP.max * HealInPercent * (math.random(975, 1025) / 1000))) / target.HP.max <= 1.02\nend\n\nif QwertCore ~= nil then\n\t\t\t\treturn TensorCore.getPredictedDirectHealHP(target, round(potency,0), false, false, false, 1) <= (QwertCore.Settings.WhmEvPartyOverhealAoe/100) + 1\nend\n\nreturn TensorCore.getPredictedDirectHealHP(target, round(potency,0), false, false, false, 1) <= 1.02",
				conditionType = 2,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 2,
				conditionLua = "local target = EntityList:Get(eventArgs.detectionTargetID)\nlocal potency = 700\n\nif not target then return false end\n\nif target.HP.percent >= 100 then return false end\n\nif Player.levels[24] ~= Player.level and Player.level <= 10 then\n    return (target.HP.percent/100) <= 0.7\nend\n\nif Player.level <= 30 then potency = 450 end\n\nif Player.levels[24] ~= Player.level and Player.level > 10 and Player.level <= 60 then\n    local x = Player.level\n    local formula = ((-7.291666666666*(10^-9)*(x^3))+(8.749999999999*(10^-7)*(x^2))-(0.0000442708*x)+(0.0015625))\n    local HealInPercent\t= (formula * potency) - (0.0005696 * (\t\t80 - Player.levels[24]))\n    if QwertCore ~= nil then\n\t\t\t\t    return (target.HP.current + (Player.HP.max * HealInPercent * (math.random(975, 1025) / 1000))) / target.HP.max <= (QwertCore.Settings.WhmEvTankOverhealSingle/100) + 1\n    end\n    return (target.HP.current + (Player.HP.max * HealInPercent * (math.random(975, 1025) / 1000))) / target.HP.max <= 1.06\nend\n\nif QwertCore ~= nil then\n\t\t\t\treturn TensorCore.getPredictedDirectHealHP(target, round(potency,0), false, false, false,0) <= (QwertCore.Settings.WhmEvTankOverhealSingle/100) + 1\nend\n\nreturn TensorCore.getPredictedDirectHealHP(target, round(potency,0), false, false, false,0) <= 1.02",
				conditionType = 2,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return QwertWHMevHealGui == nil or (WHMevLilyGui ~= nil and WHMevLilyGui == true)",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "dfc19542-25aa-7381-9e63-e158b07e4310",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "7404e418-b433-8a01-af8c-43b69a27e1e4",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "88f7886c-f001-e100-9ac2-4bd3b6ac2fbf",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "5fd14c49-57d3-a649-a990-ac72af7a8c4e",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "5836cafc-7db7-958e-8dd3-b92c174e2546",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if QwertCore ~= nil then \n   return QwertCore.Settings.WhmEvHotbar.UsePrepull.bool == true and Player.Job == 24 and Player.level >= 80\nend\nreturn Player.Job == 24 and Player.level >= 80",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "39571e78-1347-3e65-a1c0-776ee78ec95d",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "a18026a3-3e88-ae77-892a-9a8913b0d5f1",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "a6ba5d7a-febd-9524-8ff1-57d2d8037982",
	},
}
